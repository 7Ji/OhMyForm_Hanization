...
angular.module('forms').config(['$translateProvider', function ($translateProvider) {
	...
	$translateProvider.translations('en', {
		...
		SAVE_CHANGES: '保存更改',
		CANCEL: '取消',
		DISPLAY_START_PAGE: '起始页',
		DISPLAY_END_PAGE: '自定义结束页',
		GENERAL_TAB: '全局',
		SELF_NOTIFICATIONS_TAB: '制表人通知',
		RESPONDENT_NOTIFICATIONS_TAB: '填表人通知',
		...
		ADD_OPTION: '增加选项',
		NUM_OF_STEPS: '步长值',
		CLICK_FIELDS_FOOTER: '单击字段以将之添加到这里',
		SHAPE: '形状',
		IF_THIS_FIELD: '如果此字段',
		IS_EQUAL_TO: '等于',
		IS_NOT_EQUAL_TO: '不等于',
